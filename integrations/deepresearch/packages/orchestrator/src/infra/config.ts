...
const DEFAULT_RUNTIME_PROFILE: RuntimeProfile = {
  ...
  phases: {
    ...
    scout: { enabled: true, maxReactSteps: 72, maxSearchCalls: 24, maxFetchCalls: 28, contextTokenLimit: 48000, maxOutputItems: 18 },
    ...
    completionGate: { enabled: true, contextTokenLimit: 24000 },
